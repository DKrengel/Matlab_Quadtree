function[resulting_forces,old_ttanf,old_area,old_vrelt] =...
  DEM_findForce(overlap_geometry,vx0,vy0,vf0,mass0,pcx0,...
...
if (abs(contactlength-1.0)<1e-8)
  error('Probably wrong version of the overlap computation.Please verify!!!')
end
